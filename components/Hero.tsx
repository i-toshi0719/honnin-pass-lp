...
export default function Hero() {
  return (
    <section className="relative overflow-hidden border-b border-slate-100 bg-gradient-to-b from-brand-soft to-white">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
        <div className="max-w-3xl">
          <p className="inline-flex rounded-full border border-brand/30 bg-white px-4 py-1.5 text-xs font-medium text-brand-dark sm:text-sm">
            イベント・店舗の運営者向け
          </p>
          ...
          <div className="mt-8 inline-flex flex-col gap-1 rounded-2xl border border-brand/20 bg-white px-5 py-4 shadow-sm">
